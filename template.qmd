...
Tables should have a caption above them, as in @tbl-results, which is a plain markdown pipe table labeled by putting `{#tbl-results}` on its caption line and referenced with `@tbl-results`. Avoid vertical rules.
